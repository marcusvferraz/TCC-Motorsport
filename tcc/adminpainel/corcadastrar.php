        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <h4 class="page-title">  <a href="adminpainel.php">Painel</a>  /Cor - Cadastrar</h4>
                    </div>
...
<br>
      ...
      <div> 
        <input type="text" class="form-control" id="cor" name="cores" placeholder="Cadastre aqui a cor" required class="validate" >
        <br>
...
<?php
 if($_POST){
   ...
   $sql = "INSERT INTO tbl_cor (Cor_Nome) VALUES ('$color')";
