        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <h4 class="page-title">  <a href="adminpainel.php">Painel</a>  /Ano - Cadastrar</h4>
                    </div>
...
<br>
      ...
      <form action="" method="POST">
      <div> 
        <input type="number" class="form-control" id="ano" name="anos" placeholder="Cadastre aqui o Ano" required class="validate" >
        <br>
...
<?php
 if($_POST){
   ...
   $sql = "INSERT INTO tbl_ano (Ano_Ano) VALUES ('$year')";
