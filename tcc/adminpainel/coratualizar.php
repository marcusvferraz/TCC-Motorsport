        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <h4 class="page-title">  <a href="adminpainel.php">Painel</a>  /Cor - Atualizar</h4>
                    </div>
...
<br>
      ...
      <form action="" method="POST">
      <div> 
        <input type="number" class="form-control" id="cor" name="cores" placeholder="atualize aqui a Cor" required class="validate" >
        <br>
