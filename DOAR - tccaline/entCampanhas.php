                            ...
                            <div class="row">
                                ...
                                <div class="container-card justify-content-start row g-4 ">
                                    ...
                                    if ($_POST) {
                                        ...
                                        $sql = "SELECT * FROM `tbl_campanha` where camp_Status = 'ativa' and fk_Org_Campanha = $fk
                                        and camp_Nome like '%$ps%'";
                                    } else {

                                        $sql = "SELECT * FROM `tbl_campanha` where camp_Status = 'ativa' and fk_Org_Campanha = $fk  order by camp_Nome";
                                    }
                                    ...
                                    while ($dados = mysqli_fetch_array($rs)) {
                                        ...
                                        echo ' <div class="card-camp mb-3">
                                                    <div class="card-header m-0 p-0" id="card-campanha-container-imagem">
                                                        <img src="img/imagemUsuario/imgCampanha/' . $dados['camp_Imagem'] . '" class="card-img-top m-0" >
                                                    </div>
                                                    <div class="card-body-camp mt-0">
                                                        ...
                                                        <div class="justify-content-end d-flex  col-3">
                                                            <a href="entDetalheCampanha.php?id=' . $id . '">
