                                    ...
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        ...
                                        <div class="secundario col ">
                                            ...
                                            <div class="org">
                                                ...
                                                <div class=" ">
                                                    <a href='usuEntPerfil.php?id=<?php echo $idOrg; ?>' class="justify-content-between d-flex mt-4 col">
                                ...
                                <div class="card-body">
                                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                                        <div class="row">
                                            ...
                                            <!-- DATA FIM -->
                                            <div class="mb-3 col-6 col-md-3">
                                                <label class="form-label" for="dataFim">data previstas para o fim</label>
                                            ...
                                            <div class="mt-2 mb-3">
                                                ...
                                                if ($exibe) {
                                                    echo ' 
                                                    <a href="usuDoar.php?id=' . $id . '">
                                                        <button type="button" class="btn btn-primary me-2">Contribuir</button>
                                                    </a>';
                                                }
