...
$sql = "SELECT * FROM `tbl_doador` WHERE `doador_ativo` = 1";

$rs = mysqli_query($con, $sql) or die("Erro ao selecionar os usuario");

$sql2 = "SELECT * FROM `tbl_doador` WHERE `doador_ativo` = 0";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">ADM /</span> Visualizar Doador
                        </h4>
                                    ...
                                    <div class="mb-4 mt-3">
                                        <div class="row table-responsive text-nowrap p-0 m-0">
                                            ...
                                            <table class="table table-striped table-hover  col-10 mb-4" id="example">
                                                <h3 class="mt-3 text-center">Doadores Ativos</h3>
                                                <hr class="mb-5 mt-5">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    while ($dados = mysqli_fetch_array($rs)) {
                                                        ...
                                                        echo '
                                                            <tr> 
                                                                <td><strong>' . $dados['doador_Id'] . '</strong></td>
                                                                <td>' . $dados['doador_Email'] . '</td>
                                                                <td>' . $dados['doador_Nome'] . '</td>
                                                                <td> <span class="badge rounded-pill  bg-success">' . $doadorStatus . '</span></td>
                                                                <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="admEditarDoador.php?id=' . $id . '"><i class="bx bx-edit-alt me-1"></i>Editar Usuario</a>
                                                                        <a class="dropdown-item" href="php/admDesativarDoador.php?id=' . $id . '"><i class="bx bx-trash me-1"></i>Desativar Usuario</a>
                                                                    </div>
                                                                </div>
                                                                </td>
                                                            </tr>
                                    ...
                                    <div class="mb-4 mt-3">
                                        <div class="row table-responsive text-nowrap p-0 m-0">
                                            ...
                                            <table class="table table-striped table-hover  col-10 mb-4" id="example2">
                                                <h3 class="mt-3 text-center">Doadores Desativados</h3>
                                                <hr class="mb-5 mt-5">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    while ($dados2 = mysqli_fetch_array($rs2)) {
                                                        if ($dados2['doador_ativo'] == 0) {
                                                            $doadorStatus = 'desativado';
                                                        }

                                                        echo ' 
                                                            <tr> 
                                                                <td><strong>' . $dados2['doador_Id'] . '</strong></td>
                                                                <td>' . $dados2['doador_Email'] . '</td>
                                                                <td>' . $dados2['doador_Nome'] . '</td>
                                                                <td><span class="badge rounded-pill bg-warning"> ' . $doadorStatus . '</span></td>
                                                            </tr>
