...
(233, 'Teste com fk', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 'muda o agradecimento', '2022-10-13', '2022-10-21', NULL, ' marinha', 0, 'padraoDoacao.png', 'finalizada', 16),
...
(237, 'arreacada', 'bvvvvvvvvvvvbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbiiiiiii', '', '2022-10-16', '2022-10-21', NULL, 'animal', 1, '6354586179ad6.png', 'ativa', 16);
...
CREATE TABLE `tbl_doador` (
  ...
  `doador_RecuperarSenha` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_doador` (`doador_Id`, `doador_Nome`, `doador_Email`, `doador_Celular`, `doador_Nasc`, `doador_Senha`, `doador_ativo`, `doador_RecuperarSenha`) VALUES
(4, '', 'sva.aline321@gmail.com', NULL, 2002, '', 0, NULL),
(6, '', 'testeUsuario@gmail.com', NULL, 2002, '', 0, NULL),
(10, '', '333333333333', NULL, 2002, '1234567', 0, NULL),
(25, 'Nome do velho', 'velho@gmail.com', 2147483647, 2002, '$2y$10$pttLhHB51xQ2.dfebeaAyO1ko0j6BZNe01.IMYatTri./8OltRbhO', 1, NULL),
(30, ' ', 'velho54321@gmail.com', 0, 1997, '$2y$10$l88iRK7zH3V1QUYpH41ELOZMpLYZr6xLeY14hFwwDsN1qdAGB.1..', 1, NULL),
(32, ' nome', 'kkk@gmail.com', 0, 1955, '$2y$10$iozL6Ck5u.ZX1LBO0qVv/OlnBI/u./ctbrO59Wkah1Bx5hR8X1BQa', 1, NULL),
(33, ' testando o nome', 'ggg@gmail.com', 2147483647, 2004, '$2y$10$golL7vnh0rYnlmiKmdl.LOJIZgsMEe587o3t9G/x1TBwewFx7f772', 1, NULL),
(34, ' salvando o nome', 'pru@gmail.com', 0, 2003, '$2y$10$OwU8QXw1RoQvhjHV5MVd8eKDHLY4QXTBB3tQL9oCVb1mUj1BheXay', 1, NULL);
...
(11, 77, 25, 8, 'cancelada'),
(12, 81, 25, 3, 'cancelada'),
(13, 83, 25, 1, 'cancelada'),
(14, 80, 25, 5, 'pendente'),
(15, 82, 25, 9, 'pendente'),
(16, 75, 25, 5, 'pendente'),
(17, 77, 25, 5, 'pendente'),
...
CREATE TABLE `tbl_organizacao` (
  ...
  `org_RecuperarSenha` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_organizacao` (`org_Id`, `org_CNPJ`, `org_RazaoSocial`, `org_NomeFantasia`, `org_CEP`, `org_Estado`, `org_Cidade`, `org_Bairro`, `org_Rua`, `org_Numero`, `org_Complemento`, `org_Site`, `org_Telefone1`, `org_Telefone2`, `org_Celular`, `org_ImagemLogo`, `org_Sobre`, `login_Organizacao`, `senha_Organizacao`, `org_DataCadastroSite`, `org_ativo`, `org_RecuperarSenha`) VALUES
(1, 54564664664601, 'Aline testando', 'Fantasia', 12507060, 'SP', 'Guaratinguetá', 'Jardim Santa Luzia', 'Rua Hilda Maria Sobral Barbosa Mandarino', 6, '', '', 1255455355, 0, 0, '6345a81309e80.png', '', 'eeeeee@gmail.com', '$2y$10$fgfUyNVnu2rICrNd89GbbeV4cQBGx78YiqZ1D1E2YkCIUO9Ew3B9e', '2022-10-11', 0, NULL),
(10, 44444444444444, 'Aline testando 2', 'Aline testando 2', 12507060, 'SP', 'Guaratinguetá', 'Jardim Santa Luzia', 'Rua Hilda Maria Sobral Barbosa Mandarino', 777, '', '', 4444444444, 0, 0, '6345c5abc533a.png', '', 'allllll@gmail.com', '$2y$10$6OWI/btCxuI2TKiSd1j67.siWb9k6zAmY2UFeY8xSBobE2aG0QqOS', '2022-10-11', 0, NULL),
(13, 66999949949994, 'gato pru', 'gato pru', 0, 'SP', 'Guaratinguetá', 'algum santo', 'Rua Hilda Maria Sobral Barbosa Mandarino', 773, '', '', 8477746646, 0, 0, '6345c976962d0.png', '', 'joneves@hotmail.com', '$2y$10$ymUryyZsv2r9q98UyRaCX.6wZ7ZyEMQ7j6w9.aLDpZRANXfYZD1d.', '2022-10-11', 0, NULL),
(15, 77777777777777, 'testeeeeeee', 'testeeeeeee', 0, 'SP', 'Guaratinguetá', '', '3', 44, '', '', 8888888888, 0, 0, '6345ca04bb7bd.png', '', 'clirinda@gmail.com', '$2y$10$oRHI9Xxan7.hyx7QO9RISOMGATlNCon47kSmaujjIjKBne4yodxM6', '2022-10-11', 1, NULL),
(16, 12335666666669, 'Aline Cadastro', 'Teste para tudo', 12507060, 'SP', 'Guaratinguetá', 'Jardim Santa Luzia', 'Rua Hilda Maria Sobral Barbosa Mandarino', 34, 'complemento', 'site.com.br', 1544233626, 1299766355, 12995443322, '635ff22d703e1.jpg', 'funcionanaaaaggg', 'alineteste@gmail.com', '$2y$10$D9Jp/SV.9P46hx8Un8vqH.wrqeYOWsQL9TcTCqm8ZrTs3jw8AiPNq', '2022-10-13', 1, '$2y$10$jMz3LZGcdfOScyUZ0a92XOOWWHLk10iAL89YCRTwpgr9wom3ie4Ci'),
(18, 55555554444333, 'Teste bloquear', 'Bloqueando cadastro', 12507060, 'SP', 'Guaratinguetá', 'Jardim Santa Luzia', 'Rua Hilda Maria Sobral Barbosa Mandarino', 746, 'vazio', 'www.site.com', 1277465534, 1277465534, 12884766466, '635ff443e86b7.png', ' cadastra o sobre', 'shik@gmail.com', '$2y$10$x9V0wNCtZbYFCkaRWVV0pOKs9EHaIZ3VLPMkoI6nI1TvfKTzl16V.', '2022-10-15', 1, NULL);
...
(1, 0, 'clerinda teste4', 'cleri@gmail.com', 64572628827, 15),
(2, 43423256782, 'troca o resp', 'tere@gmail.com', 54626617718, 16),
(3, 0, 'Aline de novo', 'resp@hotmail.com', 0, 18);
